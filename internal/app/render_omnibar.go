...
func renderOmniBar(tenant control.Tenant, value, variant string) template.HTML {
	...
	b.WriteString(`<div id="universal-action-surface" class="` + outerClass + `"><div class="relative"><div id="omni-card" class="relative bg-white rounded-2xl shadow-sm border border-gray-200 ` + cardPadding + `">`)
